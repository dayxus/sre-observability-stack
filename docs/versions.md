...
| Alertmanager | `v0.34.0` | `v0.34.0` | up to date | `prom/alertmanager:v0.34.0` | [changelog](https://github.com/prometheus/alertmanager/blob/main/CHANGELOG.md) |
...
| Loki | `3.7.7` | `v3.7.7` | up to date | `grafana/loki:3.7.7` | [changelog](https://github.com/grafana/loki/blob/main/CHANGELOG.md) |
